...
IAIso is a Python library for bounded agent execution — the reference
SDK of the IAIso safety framework. This guide walks through the three
core patterns.
...
- `../../spec/pressure/README.md` — exact specification of the
  pressure-accumulation equation and lifecycle.
- `../../spec/consent/README.md` — JWT format and verification procedure.
- `../../spec/events/README.md` — audit event schema.
