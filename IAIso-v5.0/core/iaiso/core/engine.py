...
This is a rate-limiting / bounded-execution primitive. It is not a safety guarantee.
The coefficients are configuration, not empirical constants — they must be calibrated
for a given workload. See `iaiso.evaluation` for the calibration harness.
"""
