...
The proto is a design specification. Pin against it for prototypes;
wait for the DRAFT marker to be removed (target: IAIso spec 1.1 or 2.0)
before relying on wire-format stability across releases.
